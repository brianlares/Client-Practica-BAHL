package com.bahl.service.impl;

import com.bahl.model.dao.ClienteDao;
...
public class ClienteImplService implements IClienteService {
    ...
    public List<Cliente> findByNombre(String nombre) {
        ...
        return (List) clienteDao.findClienteByNombre(nombre);
    }

    @Override
    public String cifrar(String clearText) {

        try {
            String encrptado = encrypt(key,iv,clearText);

            return encrptado;
        }
        catch (Exception e) {
            return "Ocurrio algun error al encriptar el texto";
        }
    }
    ...
    public String descifrar(String encrypted) {
        ...
        try {
            String encrptado = decrypt(key,iv,encrypted);
